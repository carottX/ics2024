...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0000001 ????? ????? 100 ????? 01100 11", div    , R, printf("%d %d\n",src1,src2);R(rd) = (src2?(int32_t)src1 / (int32_t)src2:1));
  INSTPAT("0000001 ????? ????? 101 ????? 01100 11", divu   , R, R(rd) = (src2?(uint32_t)src1 / (uint32_t)src2:4294967295));
  INSTPAT("0000001 ????? ????? 110 ????? 01100 11", rem    , R, R(rd) = (src2?(int32_t)src1 % (int32_t)src2:src1));
