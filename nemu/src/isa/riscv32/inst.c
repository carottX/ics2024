...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("??????? ????? ????? 011 ????? 00100 11", sltiu  , I, R(rd) = (((uint32_t)src1)<(imm)?1:0));
  ...
  INSTPAT("0100000 ????? ????? 101 ????? 00100 11", srai   , I, R(rd) = src1 >> (imm & 31));
  INSTPAT("0100000 ????? ????? 111 ????? 00100 11", andi   , I, R(rd) = src1 & imm);
